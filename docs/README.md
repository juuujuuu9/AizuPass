...
| [visual-reference/INDEX-APP-MARKETING-REFERENCE.md](./visual-reference/INDEX-APP-MARKETING-REFERENCE.md) | Index.app marketing page: structure, “setup → unlock,” B2B outcome grid + pillars |
| [visual-reference/ANALYTICS-LANDING-DARK-MODE-REFERENCE.md](./visual-reference/ANALYTICS-LANDING-DARK-MODE-REFERENCE.md) | Dark-mode analytics landing screenshot: Z-pattern pillars, grid/wireframe story |
| [visual-reference/SLASH-LANDING-REFERENCE.md](./visual-reference/SLASH-LANDING-REFERENCE.md) | Slash.com: narrative arc, UI-forward hero, pricing-in-scroll, closing mirror |
...
| [STEP-2-CENTRAL-HUB.md](./STEP-2-CENTRAL-HUB.md) | Central hub: multi-event, CSV import |
